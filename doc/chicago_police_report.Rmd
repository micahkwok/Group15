...
```{r complaints images, echo = FALSE, out.width = '45%', out.height = '45%'}
...
```{r faceted histogram, echo = FALSE, out.width = '65%', out.height = '65%'}
...
```{r officer breakdown image, echo = FALSE, out.width = '45%', out.height = '45%'}
...
```{r police officer distribution, echo = FALSE, out.width = '45%', out.height = '45%'}
...
```{r police officer demographics, echo = FALSE, out.width = '45%', out.height = '45%'}
...
```{r correlation matrix image, echo = FALSE, out.width = '50%', out.height ='50%'}
...
```{r regression visualization, echo = FALSE, out.width = '75%', out.height = '75%'}
