...
To better answer whether a police staff member's salary influences their number of complaints per year, we found it helpful to start with a high level view of the Chicago Police Data and looked at the number of complaints per year. From 2007 onwards complaints per year have actually been falling, with a portion of that most likely attributed to declining total staff numbers. Instead, if we look at the complaints per year per officer in Figure 3, we see that the overall trend has not really changed from year to year.
...
```{r police officer distribution, echo = FALSE, out.width = '45%', out.height = '45%', fig.cap= "Figure 6. Distributions of Police Officer attributes in 2015", fig.show = 'hold', fig.align = 'left'}
...
```{r police officer demographics, echo = FALSE, out.width = '45%', out.height = '45%', fig.cap="Figure 7. Demographics of Police Officers in 2015", fig.show = 'hold', fig.align = 'left'}
